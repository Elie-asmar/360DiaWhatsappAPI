...
namespace _360DialogWrapperCloudAPI
{
    public static class cls_Requests
    {
        ...
        public static string POSTMediaFile_MultipartFormData(string url, string ContentType, string filepath = "", byte[] data = null, Dictionary<string, string> HEADERS = null)
        {
            try
            {
