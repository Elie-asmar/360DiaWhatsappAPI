...
{
    public partial class Form_NewAPI : Form
    {
        public Form_NewAPI()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    _360DialogWrapperCloudAPI._360DialogWrapperCloudAPI._360DialogAPIkey = "HmNoumMp6FnQIX8okOOgerBoAK";
                    var msg= _360DialogWrapperCloudAPI._360DialogWrapperCloudAPI.SendMediaFile(txtphone2.Text.Trim(), _360DialogWrapperCloudAPI.mediatype.notspecified, null, flname, capt);
